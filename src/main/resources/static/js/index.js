function validate_idcard(idcard) {
    ...
    if (idcard != "" && idcard.search(idcardReg) != -1) {
        document.getElementById("test_idcard").innerHTML = "<font color='green' size='3px'>手机号格式正确</font>";
    }else {
        document.getElementById("test_idcard").innerHTML = "<font color='red' size='3px'>手机号不能为空</font>";
    }
...
function validate_password(password) {
    ...
    if (password != "" && password.search(passwordReg) != -1) {
        ...
        document.getElementById("test_pw").innerHTML = "<font color='red' size='3px'>您输入的密码格式有误哦</font>";
        // alert("密码由数字和字母组成!");
    }
}
